    ...
    <>
      <div className="text">
        ...
        <p>
          ...
          . The plasma membrane keeps a cell intact by holding all of the
          cellular components inside. It also keeps many unwanted molecules
          outside of the cell. Internal membranes are crucial for creating
          micro-environments containing sequestered enzymes or high
          concentrations of hydrogen ions (low pH). Five general categories of
          membrane function are illustrated in the next section.{" "}
        </p>
      </div>
